...
Password
1. Rule based attack find what rules to apply
2. apply in all rules to all passwords generated by brute force and dictionary
3. Combination -> get list of strings generated by attack and then modify it by pre-appending or appending the new string

Hash mode
1. Enter hash and search for it
2. Use Tara's code to create and match hash if that doesn't work
3. Sniff packets for hashes
4. *Potentially identify ashes*
...
BCrypt must use Tara's method and talk about challenger protocol 
